                                ...
                                <div class="row">
                                    <ol class=" float-sm-right">
                                        ...
                                        @if (Auth::user()->user_type_id == 1)
                                           <a href="" data-toggle="modal" data-target="#Transfer" class="btn btn-primary" title="Fund Transfer"><i class="fas fa-plus"> Transfer</i> </a>&nbsp;

                                            <a href="" data-toggle="modal" data-target="#add" class="btn btn-primary float-sm-right" title="Add Payment "><i class="fas fa-plus"> Add Payment</i> </a>
                                        @else
                                             @if($status == 'Pending')
                                        <a href="{{ route('viewrequestamount') }}"  class="btn btn-primary float-sm-right" title="Request Amound "><i class="fas fa-plus"> Request Amount</i> </a>
                                        @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <input value="{{ $balance }}" type="text" class="form-control" name="wallet"
