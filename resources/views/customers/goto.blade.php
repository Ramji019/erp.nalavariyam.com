...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Move Members</h3>
                        </div>
                        <div class="card-body">
			...
			<form action="{{ url('/gotomembers') }}" enctype="multipart/form-data" method="post">
				{{ csrf_field() }}
				<div class="card-body">
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label for="move_as">Move as</label>
								<select class="form-control" name="move_as" id="move_as"
									style="width: 100%;" required="required">
									@if($member->user_type_id == 14)
									<option value="18">Member</option>
									<option value="20">Special Member</option>
									@endif
									@if($member->user_type_id == 15)
									<option value="19">Member</option>
									<option value="21">Special Member</option>
									@endif
								</select>
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select required class="form-control select2" name="referral" id="referral" style="width: 100%;" required="required">
									<option value="">Select Referral</option>
									@foreach($referral as $ref)
									<option value="{{ $ref->id }}">{{ $ref->id }} {{ $ref->full_name }} </option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<option value="">தொழிலின் தன்மை தேர்ந்தெடு</option>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select class="form-control select2" name="dist_id" id="district"
									style="width: 100%;" required="required">
									<option value="">மாவட்டத்தின் பெயர் தேர்ந்தெடு</option>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select class="form-control select2" name="taluk_id" id="taluk"
									style="width: 100%;" required="required">
									<option value="">தாலுக்கா தேர்ந்தெடு</option>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control"
									value="" name="full_name" id="full_name"
						...
						<div class="form-group">
								...
								<input type="text" class="form-control number"
									...
									placeholder="தொலைபேசி எண்" maxlength="10">
							</div>
							<div class="form-group">
						...
						<div class="col-md-3">
							...
							<div class="form-group">
								...
								<select class="form-control select2" name="panchayath_id"
									id="panchayath" style="width: 100%;" required="required">
									<option value="">கிராம நிர்வக பகுதி தேர்ந்தெடு</option>
