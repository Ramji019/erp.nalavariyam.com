...
@section('content')
                    ...
                    @if (Auth::user()->user_type_id == 4 ||
                        ...
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><button type="button" class="btn btn-block btn-primary btn-sm"
                                    data-toggle="modal" data-target="#Panchayathusers"><i class="fa fa-plus"> Add
                                    </i></button></li>
                        </ol>
                    @else
                    @endif
    ...
    <table id="example2" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach ($panchayathusers as $key => $panchayathuserslist)
                <tr>
                    <td>{{ $key + 1 }}</td>
                     <td>N{{ $panchayathuserslist->userID }}</td>
                    <td>{{ $panchayathuserslist->district_name }}</td>
                    <td>{{ $panchayathuserslist->taluk_name }}</td>
                    <td>{{ $panchayathuserslist->panchayath_name }}</td>
                    <td>{{ $panchayathuserslist->full_name }}</td>
                    <td>{{ $panchayathuserslist->phone }}</td>
                    <td>{{ $panchayathuserslist->status }}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="{{ url('/edituser', $panchayathuserslist->userID) }}">Edit
                                    User</a>
                                  <a onclick="userdatas('{{ $panchayathuserslist->userID }}','{{ $panchayathuserslist->full_name }}','{{ $panchayathuserslist->username }}','{{ $panchayathuserslist->district_name }}','{{ $panchayathuserslist->taluk_name }}','{{ $panchayathuserslist->panchayath_name }}','{{ $panchayathuserslist->email }}','{{ $panchayathuserslist->pas }}','{{ $panchayathuserslist->phone }}','{{ $panchayathuserslist->status }}','{{ $panchayathuserslist->user_photo }}',)" type="button" class="dropdown-item">View User</a>
								  
@if(Auth::user()->user_type_id == 1 || Auth::user()->user_type_id == 2 || Auth::user()->user_type_id == 3)
                         <a onclick="userstatus('{{ $panchayathuserslist->userID }}','{{ $panchayathuserslist->full_name }}','{{ $panchayathuserslist->from_to_date }}','{{ $panchayathuserslist->status }}')" type="button" class="dropdown-item">Status</a>
                         <a href="resetpassword/{{ $panchayathuserslist->userID }}" type="button" class="dropdown-item">Reset Password</a>

@else 

                    <a class="dropdown-item" href="{{ url('/userstatusupdate') }}/{{ $panchayathuserslist->userID }}/{{ $panchayathuserslist->user_type_id }}">Status Update</a>

               
@endif
                                <a onclick="userwallet('{{ $panchayathuserslist->userID }}','{{ $panchayathuserslist->full_name }}','{{ $panchayathuserslist->balance }}')"
    ...
    <div class="modal fade" id="Panchayathusers">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add Sub Block UsersDetails</h4>
                ...
                <form action="{{ url('/adduser') }}" method="post">
                    ...
                    @elseif(Auth::user()->user_type_id == 5 || Auth::user()->user_type_id == 7)
                    ...
                    <div class="modal-body">
                     ...
                     <input type="text" class="form-control" name="phone" id="phone" placeholder="Enter Phone" onkeyup="duplicatephone(0)"  maxlength="10">
