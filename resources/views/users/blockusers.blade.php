				 ...
				 @if (session()->has('error'))
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td>{{ $key + 1 }}</td>
                           <td>N{{ $blockuserslist->userID }}</td>
                           <td>{{ $blockuserslist->district_name }}</td>
                           <td>{{ $blockuserslist->taluk_name }}</td>
                           ...
                           <td>
                              <div class="btn-group">
								 ...
								 <a onclick="userdatas('{{ $blockuserslist->userID }}','{{ $blockuserslist->full_name }}','{{ $blockuserslist->user_photo }}','{{ $blockuserslist->username }}','{{ $blockuserslist->district_name }}','{{ $blockuserslist->email }}','{{ $blockuserslist->pas }}','{{ $blockuserslist->phone }}','{{ $blockuserslist->status }}')" type="button" class="dropdown-item">View User</a>

@if(Auth::user()->user_type_id == 1 || Auth::user()->user_type_id == 2 || Auth::user()->user_type_id == 3)
                         <a onclick="userstatus('{{ $blockuserslist->userID }}','{{ $blockuserslist->full_name }}','{{ $blockuserslist->from_to_date }}','{{ $blockuserslist->status }}')" type="button" class="dropdown-item">Status</a>
                         <a href="resetpassword/{{ $blockuserslist->userID }}" type="button" class="dropdown-item">Reset Password</a>

@else 

                    <a class="dropdown-item" href="{{ url('/userstatusupdate') }}/{{ $blockuserslist->userID }}/{{ $blockuserslist->user_type_id }}">Status Update</a>

               
@endif
								 <a onclick="userwallet('{{ $blockuserslist->userID }}','{{ $blockuserslist->full_name }}','{{ $blockuserslist->balance }}')" type="button" class="dropdown-item">View Wallet</a>
                                </div>
                              </div>
                           </td>
                        </tr>
